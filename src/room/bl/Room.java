...
{
	/**
	 * idRoom est l'indentifiant de la salle.
	 * Cet id n'est pas modifiable.
	 * Il est généré automatiquement lors de l'ajout d'une nouvelle salle dans le système.
	 * 
	...
	/**
	 * nameRoom est le nom de la salle.
	 * Ce nom est modifiable.
	 * Ce nom est entrée par l'utilisateur du système lors de l'ajout ou la modification d'une salle.
	 * 
	...
	/**
	 * surfaceRoom représente la surface de la salle en m^2
	 * Cette valeur est modifiable.
	 * 
	 * @see setDescriptionCategoryProduct(int idCategoryProduct)
	 * @see getDescriptionCategoryProduct()
	 */
	private double surfaceRoom;
	
	/**
	 * typeRoom représente le type de la salle
	 * cette valeur est modifiable
	 * 
	 * @see setDescriptionCategoryProduct(int idCategoryProduct)
	 * @see getDescriptionCategoryProduct()
	...
	/**
	 * nbMaxParticipant indique la capacité maximal de la salle
	 * cette valeur est modifiable
	 *  * <ul>
	...
	public double getSurfaceRoom() {
		return surfaceRoom;
	}


	public void setSurfaceRoom(double surfaceRoom) {
	 ...
	 * 
	 */
	public Room(int idRoom, String nameRoom, int surfaceRoom, int typeRoom, int nbMaxParticipant, ArrayList<Accessory> listAccessory ) 
	{
	...
	//Update
	public abstract void update(int idRoom, String nameRoom, int surfaceRoom, int typeRoom, int nbMaxParticipant, ArrayList<Accessory> listAccessory ) throws SQLException;
	
	//Save
	public abstract void save() throws SQLException;
	public abstract void save(String nameRoom, int surfaceRoom, int typeRoom,ArrayList<Accessory> listAccessory ) throws SQLException;
	public abstract void save(String nameRoom, int surfaceRoom, int typeRoom, int nbMaxParticipant, ArrayList<Accessory> listAccessory ) throws SQLException;
